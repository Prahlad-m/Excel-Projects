...
- Worked with `retail_sales_dataset.xlsx`:
  ...
  - Used key functions:
    ...
    - `AVERAGE` to find the average commission

### 🔍 Day 3 – Pivot Tables & Data Insights
- **Task 1: Bike Sales Lab**
  - Created Pivot Tables to analyse sales across markets, age groups, and genders
  - Key insights:
...
- **Task 2: Sales Performance by County**
  - Built Pivot Tables summarising sales by county and product
  - Used the `SWITCH` function to categorise sales volumes:
    - High (>600), Medium (300–600), Low (<300)

<img src="Images/Switch.png" width="500" >

- **Task 3: Data Visualisations**
  - Hands-on work with chart creation and visualisation using `Day_3_Task_3_Bike_Sales_Visualisations_Lab.xlsx`
